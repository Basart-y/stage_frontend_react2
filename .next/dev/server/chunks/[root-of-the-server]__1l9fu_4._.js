...
"[project]/app/api/v1/notifications/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const direct = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$backend$2f$notificationRepository$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notificationRepository"].list({
        recipientId: auth.claims.sub,
        unreadOnly,
        limit
    });
    const roleWide = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$backend$2f$notificationRepository$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notificationRepository"].list({
        audienceRole: auth.claims.role,
        viewerId: auth.claims.sub,
        unreadOnly,
        limit
    });
    const merged = [
        ...direct,
        ...roleWide
    ].filter((item, index, arr)=>arr.findIndex((candidate)=>candidate.id === item.id) === index).sort((a, b)=>String(b.createdAt).localeCompare(String(a.createdAt))).slice(0, limit);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$backend$2f$http$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["collection"])(merged, {
        limit,
        hasNext: false
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1l9fu_4._.js.map